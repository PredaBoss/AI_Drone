...
class Controller():
    ...
    def iteration(self, population_size, mutation_probability, crossover_probability):
        ...
        for _ in range(population_size):
            ...
            offspring, _ = Individual.crossover(self.repository.map, parent1, parent2,crossover_probability)
    ...
    def run(self, population_size, number_of_runs, mutation_probability, crossover_probability):
        ...
        for _ in range(number_of_runs):
            ...
            fitness_list_max.append(max([individual.fitness for individual in self.repository.population.population]))
